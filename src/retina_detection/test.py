...
class ObjectDectors(object):
    def __init__(self, wait=0.0):
        ...
        self.ret_pub = rospy.Publisher(
            "retina_ros/bounding_boxes", BoundingBoxes, queue_size=10)
        ...
        self.camera_frame = rospy.get_param(
            "camera_frame", "realsense_front_color_optical_frame")
    ...
    def image_callback(self, msg):
        ...
        try:
            ...
            for box in boxes[0]:
                ...
                if confidence > 0.1:
                    cv2.rectangle(
                        image_before_resize, (box[0], box[1]), (box[2], box[3]), (0, 255, 0), 4)
                    cv2.putText(image_before_resize, str(confidence)[
                                :4], (box[0]-2, box[1]-2), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
            ...
            msg_frame.header.frame_id = self.camera_frame
        ...
        for i in range(num_data):
            ...
            for box in boxes[0]:
                ...
                if confidence > 0.35:
                    print(box)
                    cv2.rectangle(
                        image_ori, (box[0], box[1]), (box[2], box[3]), (255, 0, 0), 2)
